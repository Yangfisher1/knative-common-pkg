...
import (
	...
	kmp "github.com/Yangfisher1/knative-common-pkg/kmp"
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1.Node, desired *v1.Node) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.Node) (*v1.Node, error) {
