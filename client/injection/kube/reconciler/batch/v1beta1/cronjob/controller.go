...
import (
	...
	cronjob "github.com/Yangfisher1/knative-common-pkg/client/injection/kube/informers/batch/v1beta1/cronjob"
...
const (
	defaultControllerAgentName = "cronjob-controller"
	defaultFinalizerName       = "cronjobs.batch"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	cronjobInformer := cronjob.Get(ctx)

	lister := cronjobInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "batch.CronJob"),
	)
