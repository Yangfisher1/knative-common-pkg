...
import (
	...
	mutatingwebhookconfiguration "github.com/Yangfisher1/knative-common-pkg/client/injection/kube/informers/admissionregistration/v1/mutatingwebhookconfiguration"
...
const (
	defaultControllerAgentName = "mutatingwebhookconfiguration-controller"
	defaultFinalizerName       = "mutatingwebhookconfigurations.admissionregistration.k8s.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	mutatingwebhookconfigurationInformer := mutatingwebhookconfiguration.Get(ctx)

	lister := mutatingwebhookconfigurationInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "admissionregistration.k8s.io.MutatingWebhookConfiguration"),
	)
