...
import (
	...
	validatingwebhookconfiguration "github.com/Yangfisher1/knative-common-pkg/client/injection/kube/informers/admissionregistration/v1beta1/validatingwebhookconfiguration"
...
const (
	defaultControllerAgentName = "validatingwebhookconfiguration-controller"
	defaultFinalizerName       = "validatingwebhookconfigurations.admissionregistration.k8s.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	validatingwebhookconfigurationInformer := validatingwebhookconfiguration.Get(ctx)

	lister := validatingwebhookconfigurationInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "admissionregistration.k8s.io.ValidatingWebhookConfiguration"),
	)
