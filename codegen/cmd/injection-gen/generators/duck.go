...
func (g *duckGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"injectionRegisterDuck":     c.Universe.Type(types.Name{Package: "github.com/Yangfisher1/knative-common-pkg/injection", Name: "Default.RegisterDuck"}),
		"getResyncPeriod":           c.Universe.Type(types.Name{Package: "github.com/Yangfisher1/knative-common-pkg/controller", Name: "GetResyncPeriod"}),
		"dynamicGet":                c.Universe.Type(types.Name{Package: "github.com/Yangfisher1/knative-common-pkg/injection/clients/dynamicclient", Name: "Get"}),
		"duckTypedInformerFactory":  c.Universe.Type(types.Name{Package: "github.com/Yangfisher1/knative-common-pkg/apis/duck", Name: "TypedInformerFactory"}),
		"duckCachedInformerFactory": c.Universe.Type(types.Name{Package: "github.com/Yangfisher1/knative-common-pkg/apis/duck", Name: "CachedInformerFactory"}),
		"duckInformerFactory":       c.Universe.Type(types.Name{Package: "github.com/Yangfisher1/knative-common-pkg/apis/duck", Name: "InformerFactory"}),
